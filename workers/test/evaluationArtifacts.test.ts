...
describe("evaluation-only identity artifacts", () => {
  it("writes the fixed stage set only under an explicit case directory", async () => {
    ...
    const output = await writeIdentityEvaluationArtifacts(root, "glasses-case", {
      ...
      majorVolumeOverlay: buildMajorVolumeGeometryOverlay(image, analysis.identityGeometry!),
    ...
    expect(files).toEqual(expect.arrayContaining([
      ...
      "10-final-skin.png",
      "source-head.png",
      "source-head-geometry-overlay.png",
      "fringe-overlay.png",
      "temple-overlay.png",
      "crown-overlay.png",
      "major-volume-overlay.png",
      "face-window-overlay.png",
      "quantized-plan.png",
      "final-head.png",
      "six-view.png",
      "critique.json",
