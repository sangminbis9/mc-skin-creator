...
const CASES: ArtifactCase[] = [
  {
    ...
    measuredGeometry: (geometry) => applyCropVisibility({
      ...geometry,
      diagnostics: { ...geometry.diagnostics, derivedMeasurements: [] },
      ...
      temple: { leftRecession: 0.7, rightRecession: 0.58, leftStartY: 0.36, rightStartY: 0.32, asymmetry: 0.12, leftEvidence: "observed", rightEvidence: "observed", leftConfidence: 0.86, rightConfidence: 0.86, confidence: 0.86 },
      crown: { leftY: 0.2, centerY: 0.15, rightY: 0.19, leftWidth: 0.22, rightWidth: 0.24, apexX: 0.49, asymmetry: 0.16, leftEvidence: "observed", centerEvidence: "observed", rightEvidence: "observed", leftConfidence: 0.86, centerConfidence: 0.86, rightConfidence: 0.86, evidence: "observed", confidence: 0.86 },
      majorVolumePeaks: [
      ...
      faceWindow: { foreheadHeight: 0.31, leftTempleWidth: 0.74, rightTempleWidth: 0.66, visibleFaceWidthAtEyes: 0.36, visibleFaceWidthAtCheeks: 0.42, leftEyeToHairDistance: 0.2, rightEyeToHairDistance: 0.18, leftEarExposure: 0.88, rightEarExposure: 0.78, leftEvidence: "observed", rightEvidence: "observed", leftConfidence: 0.86, rightConfidence: 0.86, confidence: 0.86 },
  ...
  },
  {
    ...
    measuredGeometry: (geometry) => applyCropVisibility({
      ...
      temple: { leftRecession: 0.18, rightRecession: 0.3, leftStartY: 0.38, rightStartY: 0.34, asymmetry: -0.12, leftEvidence: "observed", rightEvidence: "observed", leftConfidence: 0.8, rightConfidence: 0.8, confidence: 0.8 },
      crown: { leftY: 0.03, centerY: 0.04, rightY: 0.1, leftWidth: 0.92, rightWidth: 0.7, apexX: 0.22, asymmetry: -0.36, leftEvidence: "observed", centerEvidence: "observed", rightEvidence: "observed", leftConfidence: 0.8, centerConfidence: 0.8, rightConfidence: 0.8, evidence: "observed", confidence: 0.8 },
      majorVolumePeaks: [
      ...
      faceWindow: { foreheadHeight: 0.36, leftTempleWidth: 0.22, rightTempleWidth: 0.38, visibleFaceWidthAtEyes: 0.46, visibleFaceWidthAtCheeks: 0.5, leftEyeToHairDistance: 0.16, rightEyeToHairDistance: 0.22, leftEarExposure: 0.04, rightEarExposure: 0.08, leftEvidence: "observed", rightEvidence: "observed", leftConfidence: 0.8, rightConfidence: 0.8, confidence: 0.8 },
    ...
    }, { crownClipped: false, leftHairClipped: false, rightHairClipped: false, chinClipped: false, leftEarClipped: false, rightEarClipped: false, cropClippingKnown: false, sourceClippingKnown: false }),
...
describe.skipIf(!RUN)("offline hair identity evaluation artifacts", () => {
  for (const sample of CASES) it(sample.id, async () => {
    ...
    await writeIdentityEvaluationArtifacts(OUTPUT_ROOT, sample.id, {
      ...
      majorVolumeOverlay: buildMajorVolumeGeometryOverlay(sourceHead, measuredGeometry),
