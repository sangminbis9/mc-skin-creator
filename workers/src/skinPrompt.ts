...
export function buildSkinPrompt(
  ...
  lines.push(
    ...
    `Carry these low-resolution identity priorities into the atlas: ${analysis.renderHints.faceShape} face, ${analysis.renderHints.eyeShape} eyes, ${analysis.renderHints.bangsLength} ${analysis.renderHints.bangs} bangs, ${analysis.renderHints.hairTexture} ${analysis.renderHints.hairVolume}-volume ${analysis.renderHints.hairSilhouette} hair, ${analysis.renderHints.hairBackShape} back hair, ${analysis.renderHints.hairPart} parting, ${analysis.renderHints.sideHairLength} side hair.`,
